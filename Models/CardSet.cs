...
public class CardSet {
	...
	public CardSet SubSet(int startIndex, int count) {
		return new CardSet(cards.GetRange (startIndex, count));
	}

	public List<Card> SubSetList(int startIndex, int count) {
		return cards.GetRange (startIndex, count);
	}
}